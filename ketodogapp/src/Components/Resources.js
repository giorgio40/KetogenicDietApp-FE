    ...
    <div>
      <div>
        <Card
          ...
          title="OTTO WARBURG"
          description="Otto Warburg was a biochemist from the 1920's who won a Nobel Prize for his research on Cancer. Warburg's central Theory was that Cancer cells in the presence of Oxygen are fermenting glucose as a source of ATP , which is how they fuel themselves. He hypothesized that cancer cells have damaged mitochondria and can not use oxygen this is why they made a switch to glucose, This is called the Warburg Effect. The warburg effect can be observed if you have cancer and they inject you with radioactive glucose and the cancer lights up like a Christmas tree."
        />
      </div>
      <div>
        <Card
      ...
      <div>
        <Card
          ...
          description="Dr. Angela Poff is a collegue of Dr. D'Agastino and she is well versed in how the ketogenic diet and other modalities like hyperbaric oxygen can have an effect on cancer"
        />
      </div>
      <div>
        <Card
